...
public class DepartmentSystemController {
    ...
    public String addDeptsysPost(@ModelAttribute("deptsys") DepartmentsystemEntity departmentsystemEntity, ModelMap modelMap) {
        ...
        departmentsystemEntity.setCreateTime(new Timestamp(System.currentTimeMillis()));

        departmentsystemRepository.saveAndFlush(departmentsystemEntity);

        System.out.println(departmentsystemEntity.getCreateTime());
    ...
    public String updateDeptsysPost(@ModelAttribute("deptsysU") DepartmentsystemEntity departmentsystem) {
        ...
        departmentsystemRepository.updateDeptsys(departmentsystem.getDeptName(), departmentsystem.getSystemName(),
                departmentsystem.getCreateTime(), departmentsystem.getId());
    ...
    @RequestMapping(value = "/admin/deptsys/delete/{id}", method = RequestMethod.GET)
    public String deleteDeptsys(@PathVariable("id") Integer deptsysId, ModelMap modelMap) {

        departmentsystemRepository.delete(deptsysId);
